const caseStudyData = {
  'credit-card': {
    ...
    process: `<div class="process-section">
      <h3>User Research</h3>
      <p>Our approach began with comprehensive user research, including interviews, surveys, and usability testing. We analyzed user behavior patterns and identified common friction points in the payment process.</p>
    </div>`,
  ...
  'zine-studio': {
    title: 'Zine Studio App',
    description: 'A UX case study on designing a seamless, modern app to help users track their spending, manage subscriptions, and visualize financial insights.',
    images: [
      "images/case1.png",
    ],
  },
